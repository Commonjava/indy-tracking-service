...
public class TransferDTO
                implements Comparable<TransferDTO>
{
    ...
    public TransferDTO( final StoreKey storeKey, final TrackingKey trackingKey, final AccessChannel accessChannel, final String path, final String originUrl, final StoreEffect effect )
    {
    ...
    @Override
    public int compareTo( final TransferDTO other )
    {
